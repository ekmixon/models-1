...
class TfdsProcessor(DataProcessor):
  ...
  def _process_tfds_params_str(self, params_str):
    ...
    self.data_dir = d.get("data_dir")
    self.module_import = d.get("module_import")
    ...
    self.text_b_key = d.get("text_b_key")
    ...
    self.weight_key = d.get("weight_key")
    self.skip_label = d.get("skip_label")
